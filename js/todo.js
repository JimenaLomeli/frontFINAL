...
function loadTodos() {
  $.ajax({
    ...
    url: 'https://exfinal818665.herokuapp.com/todos',
    headers: {
...
function addTodo(id, todoText, completed) {
  if(completed){
    $('#todo-list').append('<li><input type="checkbox" name="todo" value="'+id+'" checked><span>'+todoText+'</span></li>')
  }else{
    $('#todo-list').append('<li><input type="checkbox" name="todo" value="'+id+'"><span>'+todoText+'</span></li>')
  }
}